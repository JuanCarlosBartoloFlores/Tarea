...
public interface Habilidades<T> {
    void realizarAccion(T target);
}
...
public class Jugador extends Personaje implements Habilidades<Personaje> {
    String clase;
    ...
    @Override
    public void realizarAccion(Personaje target) {
        if (target instanceof HabilidadesFisicas) {
            realizarAtaqueFisico();
        } else if (target instanceof HabilidadesMagicas) {
            lanzarHechizo();
        }
    }
...
public class Enemigo extends Personaje implements Habilidades<Personaje> {
    String tipo;
...
public interface HabilidadesFisicas {
    // Método para habilidades físicas
    void realizarAtaqueFisico();
}

public interface HabilidadesMagicas {
    // Método para habilidades mágicas
    void lanzarHechizo();
}
...
public class Ejecutar {
    public static void main(String[] args) {
        ...
        System.out.println("¡La batalla ha comenzado! " + jugador.nombre + " se enfrenta al " + enemigo.nombre + ".");

        // Realizar acciones genéricas
        System.out.println(jugador.nombre + " decide atacar al " + enemigo.nombre + ".");
        jugador.realizarAccion(enemigo);

        System.out.println(enemigo.nombre + " contraataca.");
        enemigo.realizarAccion(jugador);
